...
async function linkStock() {
    console.log("--- Linking Existing Stock ---");

    // 1. Find Stock Item by Name
    ...
    if (stockError || !stockItem) {
        console.error(`❌ Stock Item '${stockName}' NOT FOUND. Did you create it?`);
    ...
    if (linkError) {
        ...
        console.log("✅ SUCCESSFULLY Linked 'Croissant' -> 'Croissant (Estoque)' (1 un)");
    }
}
