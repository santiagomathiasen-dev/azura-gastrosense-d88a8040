...
import { ChefHat, Loader2, Mail, Lock, User, Eye, EyeOff, KeyRound } from 'lucide-react';
        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <div className="w-full max-w-md">
                <div className="flex flex-col items-center mb-6">
                    ...
                    <h1 className="text-xl font-bold text-foreground">Controle Azura</h1>
                    <p className="text-sm text-muted-foreground">Gestão Gastronômica</p>
                </div>

                <Card className="border-border/50 shadow-xl">
                    <CardHeader className="text-center pb-3">
                        <CardTitle className="text-lg text-card-foreground">{isLogin ? 'Bem-vindo de volta' : 'Criar conta'}</CardTitle>
