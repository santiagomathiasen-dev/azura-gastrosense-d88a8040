                        ...
                        <Card key={collab.id} className={!collab.is_active ? 'opacity-60' : ''}>
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="min-w-0 space-y-1">
                                        ...
                                        <div className="flex gap-1.5">
                                            {!collab.is_active && (
                                                <Badge variant="destructive" className="text-[10px] h-4">Inativo</Badge>
                                            )}
                                        </div>
                                    </div>
                                    <Switch
                            ...
                            <CardContent className="space-y-3">
                                ...
                                <div className="flex gap-1.5 pt-2">
                                    <Button variant="ghost" size="sm" className="h-8 w-8 p-0" onClick={() => handleOpenEdit(collab)}>
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                ...
                                                <AlertDialogAction onClick={() => deleteCollaborator.mutate(collab.id)} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
                                                    Remover
                                                </AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
